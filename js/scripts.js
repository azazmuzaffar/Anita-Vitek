...
zaid_story
  ...
  .fromTo(
    [storyBgImage, storyText, storyImg2, storybtn],
    {
      opacity: 0,
    },
    {
...
hpVideo1.addEventListener("click", function (e) {
  ...
  let currentCursor = hpVideo1.style.cursor;
  if (currentCursor.includes("play")) {
    hpVideo1.style.cursor = "url('./images/icons/svg/pause.svg'), auto";
  } else {
    hpVideo1.style.cursor = "url('./images/icons/svg/play.svg'), auto";
  }
});
